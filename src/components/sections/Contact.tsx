...
import { submitLead, getWhatsAppUrl, LeadFormData } from '@/lib/submitAdapter'
        ...
        <GlassCard variant="strong" hover={false} className="p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              >
                <option value="web">Web custom</option>
                <option value="sistema">Sistema / Backoffice</option>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button
                ...
                size="lg"
                icon={<WhatsAppIcon />}
                onClick={() => window.open(getWhatsAppUrl(formData), '_blank')}
                className="flex-1"
              >
                Enviar por WhatsApp
              </Button>
